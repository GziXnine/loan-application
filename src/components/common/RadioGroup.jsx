...
const RadioGroup = forwardRef(function RadioGroup(
  ...
  return (
    ...
    >
      {/* Legend / Label */}
      {label && (
        <legend className={clsx('form-label', { 'form-label-required': required })}>
          {label}
        </legend>
      )}
            ...
            return (
              <label
                ...
                className={clsx(
                  ...
                  'hover:shadow-soft',
                  {
                    'border-primary-500 bg-primary-50/50 shadow-glow-primary': isSelected,
                    'border-surface-200 bg-white hover:border-primary-200': !isSelected,
            ...
            >
              <input
                ...
                className={clsx(
                  ...
                  {
                    'border-primary-500 bg-primary-500 shadow-[inset_0_0_0_3px_white]': isSelected,
                    'border-surface-300 group-hover:border-primary-300': !isSelected,
                  }
                )}
                {...rest}
              />
